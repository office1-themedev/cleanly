...
class CleanlyRefund extends StatefulWidget {
  const CleanlyRefund({Key ? key}) : super(key: key);

  @override
  _CleanlyRefundState createState() => _CleanlyRefundState();
}
String ? baseUrl;
String ? apiKey;
String appData = '';
...
class _CleanlyRefundState extends State<CleanlyRefund>{
...
// call Auth method
  ...
  String titleReport = 'Refund Reports';
  ...
  Future<void> getApi(String period) async {
    ...
    try{
      http.Response response = await http.post(
          Uri.parse('${baseUrl}cleanly/v1/refund'),
          body: {
            'key': apiKey,
            'period': period,
          }
